...
def cross(d1, d2):
    design = Design(d1.experiment)
    
    design.design = cross_orders(d1.design, d2.design)
    
    return design

def cross_orders(o1, o2):
    assert o1.n == o2.n
...
class Design:
    ...
    def within_subjects(self, variables):
        ...
        n = math.prod(list(map(lambda variable: len(variable), variables)))
        print(n)
        self.design = pick_n(n, variables)
        return self

    def counterbalance(self, variable):
        variable.counterbalance = 1
        self.design = no_repeat(self.design) 
        return self


    def __str__(self):
        return self.design.__str__()
...
# treatment = variable("treatment", ["a", "b", "c"])
# units = units(24)
...
# design = cross(task_design, treatment_design)

# assignment = (Experiment(design)
#     .assign(units)
#     .counterbalance()
# )
